...
import org.l2s.gameserver.ai.NextAction;
import org.l2s.gameserver.data.xml.impl.FakePlayerData;
import org.l2s.gameserver.handler.IPlayerActionHandler;
import org.l2s.gameserver.model.ActionDataHolder;
...
import org.l2s.gameserver.network.serverpackets.ExAskCoupleAction;
...
public class SocialAction implements IPlayerActionHandler
{
	...
	private boolean useSocial(PlayerInstance player, int id)
	{
		...
		{
			player.broadcastPacket(new org.l2s.gameserver.network.serverpackets.SocialAction(player.getObjectId(), id));
