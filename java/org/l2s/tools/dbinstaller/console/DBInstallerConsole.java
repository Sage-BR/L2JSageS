 ...
 */
package org.l2s.tools.dbinstaller.console;

import java.sql.Connection;
import java.util.Scanner;
import java.util.prefs.Preferences;

import org.l2s.tools.dbinstaller.DBOutputInterface;
import org.l2s.tools.dbinstaller.RunTasks;
import org.l2s.tools.dbinstaller.util.CloseShieldedInputStream;
