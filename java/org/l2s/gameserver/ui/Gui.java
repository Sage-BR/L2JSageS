...
import org.l2s.commons.util.LimitLinesDocumentListener;
import org.l2s.commons.util.SplashScreen;
import org.l2s.gameserver.Shutdown;
...
public class Gui
{
	...
	public Gui()
	{
		...
		// Set frame.
		JFrame frame = new JFrame("SageS - GameServer");
		...
		frame.getContentPane().setPreferredSize(new Dimension(800, 350));
		frame.pack();
