 ...
 */
package org.l2s.gameserver.model.stats.functions;

import org.l2s.gameserver.enums.StatFunction;
...
public class FuncTemplate
{
	...
	public FuncTemplate(Condition attachCond, Condition applayCond, String functionName, int order, Stats stat, double value)
	{
		...
		try
		{
			_functionClass = Class.forName("org.l2s.gameserver.model.stats.functions.Func" + function.getName());
		}
