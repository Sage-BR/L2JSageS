...
import org.l2s.gameserver.instancemanager.InstanceManager;
import org.l2s.gameserver.instancemanager.PcCafePointsManager;
import org.l2s.gameserver.instancemanager.ZoneManager;
import org.l2s.gameserver.model.Location;
import org.l2s.gameserver.model.Spawn;
...
import org.l2s.gameserver.model.actor.instance.DoorInstance;
import org.l2s.gameserver.model.actor.instance.MonsterInstance;
import org.l2s.gameserver.model.actor.instance.PlayerInstance;
import org.l2s.gameserver.model.actor.instance.TrapInstance;
import org.l2s.gameserver.model.actor.templates.NpcTemplate;
import org.l2s.gameserver.model.entity.Castle;
import org.l2s.gameserver.model.entity.Fort;
import org.l2s.gameserver.model.events.annotations.Id;
import org.l2s.gameserver.model.events.annotations.Ids;
import org.l2s.gameserver.model.events.annotations.NpcLevelRange;
import org.l2s.gameserver.model.events.annotations.NpcLevelRanges;
import org.l2s.gameserver.model.events.annotations.Priority;
import org.l2s.gameserver.model.events.annotations.Range;
import org.l2s.gameserver.model.events.annotations.Ranges;
import org.l2s.gameserver.model.events.annotations.RegisterEvent;
import org.l2s.gameserver.model.events.annotations.RegisterType;
...
import org.l2s.gameserver.model.events.listeners.AbstractEventListener;
import org.l2s.gameserver.model.events.listeners.AnnotationEventListener;
import org.l2s.gameserver.model.events.listeners.ConsumerEventListener;
import org.l2s.gameserver.model.events.listeners.DummyEventListener;
import org.l2s.gameserver.model.events.listeners.FunctionEventListener;
import org.l2s.gameserver.model.events.listeners.RunnableEventListener;
import org.l2s.gameserver.model.events.returns.AbstractEventReturn;
import org.l2s.gameserver.model.events.returns.TerminateReturn;
import org.l2s.gameserver.model.events.timers.IEventTimerCancel;
import org.l2s.gameserver.model.events.timers.IEventTimerEvent;
import org.l2s.gameserver.model.events.timers.TimerHolder;
import org.l2s.gameserver.model.holders.ItemHolder;
import org.l2s.gameserver.model.holders.MovieHolder;
import org.l2s.gameserver.model.holders.SkillHolder;
import org.l2s.gameserver.model.instancezone.Instance;
import org.l2s.gameserver.model.instancezone.InstanceTemplate;
import org.l2s.gameserver.model.interfaces.IPositionable;
...
import org.l2s.gameserver.model.items.enchant.attribute.AttributeHolder;
import org.l2s.gameserver.model.items.instance.ItemInstance;
import org.l2s.gameserver.model.olympiad.Olympiad;
import org.l2s.gameserver.model.skills.Skill;
import org.l2s.gameserver.model.spawns.SpawnGroup;
import org.l2s.gameserver.model.spawns.SpawnTemplate;
...
import org.l2s.gameserver.network.serverpackets.PlaySound;
import org.l2s.gameserver.network.serverpackets.SpecialCamera;
import org.l2s.gameserver.network.serverpackets.SystemMessage;
import org.l2s.gameserver.scripting.ManagedScript;
import org.l2s.gameserver.util.MinionList;
...
public abstract class AbstractScript extends ManagedScript implements IEventTimerEvent<String>, IEventTimerCancel<String>
{
	...
	/**
	 * Provides instant callback operation when {@link org.l2s.gameserver.model.actor.Creature} Enters on a {@link ZoneType}.
	 * @param callback
	 * @param npcIds
	 * @return
	 */
	...
	/**
	 * Provides instant callback operation when {@link org.l2s.gameserver.model.actor.Creature} Exits on a {@link ZoneType}.
	 * @param callback
	 * @param npcIds
	 * @return
	 */
	...
	/**
	 * Provides instant callback operation when {@link org.l2s.gameserver.model.actor.instance.TrapInstance} acts.
	 * @param callback
	 * @param npcIds
	 * @return
	 */
	 ...
	 * Use this method instead of importing {@link org.l2s.commons.util.Rnd} utility.
	...
	/**
	 * @return the number of ticks from the {@link org.l2s.gameserver.GameTimeController}.
	 */
