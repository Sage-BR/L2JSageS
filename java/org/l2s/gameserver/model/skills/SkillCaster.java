 ...
 */
package org.l2s.gameserver.model.skills;

import static org.l2s.gameserver.ai.CtrlIntention.AI_INTENTION_ATTACK;
...
import org.l2s.gameserver.model.holders.ItemSkillHolder;
...
import org.l2s.gameserver.network.serverpackets.FlyToLocation;
import org.l2s.gameserver.network.serverpackets.FlyToLocation.FlyType;
import org.l2s.gameserver.network.serverpackets.MagicSkillCanceld;
import org.l2s.gameserver.network.serverpackets.MagicSkillLaunched;
import org.l2s.gameserver.network.serverpackets.MagicSkillUse;
import org.l2s.gameserver.network.serverpackets.MoveToPawn;
