 ...
 */
package org.l2s.gameserver.model;
...
import org.l2s.gameserver.network.serverpackets.ExAskModifyPartyLooting;
import org.l2s.gameserver.network.serverpackets.ExCloseMPCC;
import org.l2s.gameserver.network.serverpackets.ExOpenMPCC;
...
import org.l2s.gameserver.network.serverpackets.ExSetPartyLooting;
import org.l2s.gameserver.network.serverpackets.ExTacticalSign;
import org.l2s.gameserver.network.serverpackets.IClientOutgoingPacket;
import org.l2s.gameserver.network.serverpackets.PartyMemberPosition;
import org.l2s.gameserver.network.serverpackets.PartySmallWindowAdd;
import org.l2s.gameserver.network.serverpackets.PartySmallWindowAll;
import org.l2s.gameserver.network.serverpackets.PartySmallWindowDelete;
import org.l2s.gameserver.network.serverpackets.PartySmallWindowDeleteAll;
...
public class Party extends AbstractPlayerGroup
{
	 ...
	 * @see org.l2s.gameserver.model.actor.instance.PlayerInstance#isRequestExpired()
	 */
