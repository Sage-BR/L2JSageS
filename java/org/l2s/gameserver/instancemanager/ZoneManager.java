 ...
 */
package org.l2s.gameserver.instancemanager;
...
import org.l2s.commons.util.IXmlReader;
...
import org.l2s.gameserver.model.zone.AbstractZoneSettings;
import org.l2s.gameserver.model.zone.ZoneForm;
import org.l2s.gameserver.model.zone.ZoneRegion;
import org.l2s.gameserver.model.zone.ZoneRespawn;
import org.l2s.gameserver.model.zone.ZoneType;
import org.l2s.gameserver.model.zone.form.ZoneCuboid;
import org.l2s.gameserver.model.zone.form.ZoneCylinder;
import org.l2s.gameserver.model.zone.form.ZoneNPoly;
import org.l2s.gameserver.model.zone.type.ArenaZone;
import org.l2s.gameserver.model.zone.type.CastleZone;
import org.l2s.gameserver.model.zone.type.ClanHallZone;
import org.l2s.gameserver.model.zone.type.ConditionZone;
import org.l2s.gameserver.model.zone.type.DamageZone;
import org.l2s.gameserver.model.zone.type.DerbyTrackZone;
import org.l2s.gameserver.model.zone.type.EffectZone;
import org.l2s.gameserver.model.zone.type.FishingZone;
import org.l2s.gameserver.model.zone.type.FortZone;
import org.l2s.gameserver.model.zone.type.HqZone;
import org.l2s.gameserver.model.zone.type.JailZone;
import org.l2s.gameserver.model.zone.type.LandingZone;
import org.l2s.gameserver.model.zone.type.MotherTreeZone;
import org.l2s.gameserver.model.zone.type.NoLandingZone;
import org.l2s.gameserver.model.zone.type.NoRestartZone;
import org.l2s.gameserver.model.zone.type.NoStoreZone;
import org.l2s.gameserver.model.zone.type.NoSummonFriendZone;
import org.l2s.gameserver.model.zone.type.OlympiadStadiumZone;
import org.l2s.gameserver.model.zone.type.PeaceZone;
import org.l2s.gameserver.model.zone.type.ResidenceHallTeleportZone;
import org.l2s.gameserver.model.zone.type.ResidenceTeleportZone;
import org.l2s.gameserver.model.zone.type.ResidenceZone;
import org.l2s.gameserver.model.zone.type.RespawnZone;
import org.l2s.gameserver.model.zone.type.SayuneZone;
import org.l2s.gameserver.model.zone.type.ScriptZone;
import org.l2s.gameserver.model.zone.type.SiegableHallZone;
import org.l2s.gameserver.model.zone.type.SiegeZone;
import org.l2s.gameserver.model.zone.type.SpawnTerritory;
import org.l2s.gameserver.model.zone.type.SwampZone;
import org.l2s.gameserver.model.zone.type.TaxZone;
import org.l2s.gameserver.model.zone.type.TeleportZone;
import org.l2s.gameserver.model.zone.type.UndyingZone;
			...
			if ("list".equalsIgnoreCase(n.getNodeName()))
			{
				...
				for (Node d = n.getFirstChild(); d != null; d = d.getNextSibling())
				{
					if ("zone".equalsIgnoreCase(d.getNodeName()))
					{
						...
						try
						{
							newZone = Class.forName("org.l2s.gameserver.model.zone.type." + zoneType);
