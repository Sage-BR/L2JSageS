 ...
 */
package org.l2s.gameserver.engines.items;
...
import org.l2s.gameserver.engines.DocumentBase;
...
public class DocumentItem extends DocumentBase implements IXmlReader
{
	...
	private void makeItem() throws InvocationTargetException
	{
		...
		try
		{
			final Constructor<?> itemClass = Class.forName("org.l2s.gameserver.model.items." + _currentItem.type).getConstructor(StatsSet.class);
