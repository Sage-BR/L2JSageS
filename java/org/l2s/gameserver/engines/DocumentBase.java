 ...
 */
package org.l2s.gameserver.engines;
...
import org.l2s.gameserver.model.base.PlayerState;
import org.l2s.gameserver.model.conditions.Condition;
import org.l2s.gameserver.model.conditions.ConditionCategoryType;
import org.l2s.gameserver.model.conditions.ConditionChangeWeapon;
import org.l2s.gameserver.model.conditions.ConditionGameChance;
import org.l2s.gameserver.model.conditions.ConditionGameTime;
import org.l2s.gameserver.model.conditions.ConditionGameTime.CheckGameTime;
import org.l2s.gameserver.model.conditions.ConditionLogicAnd;
import org.l2s.gameserver.model.conditions.ConditionLogicNot;
import org.l2s.gameserver.model.conditions.ConditionLogicOr;
import org.l2s.gameserver.model.conditions.ConditionMinDistance;
import org.l2s.gameserver.model.conditions.ConditionMinimumVitalityPoints;
import org.l2s.gameserver.model.conditions.ConditionPlayerActiveEffectId;
import org.l2s.gameserver.model.conditions.ConditionPlayerActiveSkillId;
import org.l2s.gameserver.model.conditions.ConditionPlayerAgathionId;
import org.l2s.gameserver.model.conditions.ConditionPlayerCallPc;
import org.l2s.gameserver.model.conditions.ConditionPlayerCanCreateBase;
import org.l2s.gameserver.model.conditions.ConditionPlayerCanEscape;
import org.l2s.gameserver.model.conditions.ConditionPlayerCanRefuelAirship;
import org.l2s.gameserver.model.conditions.ConditionPlayerCanResurrect;
import org.l2s.gameserver.model.conditions.ConditionPlayerCanSummonPet;
import org.l2s.gameserver.model.conditions.ConditionPlayerCanSummonServitor;
import org.l2s.gameserver.model.conditions.ConditionPlayerCanSummonSiegeGolem;
import org.l2s.gameserver.model.conditions.ConditionPlayerCanSweep;
import org.l2s.gameserver.model.conditions.ConditionPlayerCanSwitchSubclass;
import org.l2s.gameserver.model.conditions.ConditionPlayerCanTakeCastle;
import org.l2s.gameserver.model.conditions.ConditionPlayerCanTakeFort;
import org.l2s.gameserver.model.conditions.ConditionPlayerCanTransform;
import org.l2s.gameserver.model.conditions.ConditionPlayerCanUntransform;
import org.l2s.gameserver.model.conditions.ConditionPlayerCharges;
import org.l2s.gameserver.model.conditions.ConditionPlayerCheckAbnormal;
import org.l2s.gameserver.model.conditions.ConditionPlayerClassIdRestriction;
import org.l2s.gameserver.model.conditions.ConditionPlayerCloakStatus;
import org.l2s.gameserver.model.conditions.ConditionPlayerCp;
import org.l2s.gameserver.model.conditions.ConditionPlayerDualclass;
import org.l2s.gameserver.model.conditions.ConditionPlayerFlyMounted;
import org.l2s.gameserver.model.conditions.ConditionPlayerHasCastle;
import org.l2s.gameserver.model.conditions.ConditionPlayerHasClanHall;
import org.l2s.gameserver.model.conditions.ConditionPlayerHasFort;
import org.l2s.gameserver.model.conditions.ConditionPlayerHasFreeSummonPoints;
import org.l2s.gameserver.model.conditions.ConditionPlayerHasFreeTeleportBookmarkSlots;
import org.l2s.gameserver.model.conditions.ConditionPlayerHasPet;
import org.l2s.gameserver.model.conditions.ConditionPlayerHasSummon;
import org.l2s.gameserver.model.conditions.ConditionPlayerHp;
import org.l2s.gameserver.model.conditions.ConditionPlayerImmobile;
import org.l2s.gameserver.model.conditions.ConditionPlayerInInstance;
import org.l2s.gameserver.model.conditions.ConditionPlayerInsideZoneId;
import org.l2s.gameserver.model.conditions.ConditionPlayerInstanceId;
import org.l2s.gameserver.model.conditions.ConditionPlayerInvSize;
import org.l2s.gameserver.model.conditions.ConditionPlayerIsClanLeader;
import org.l2s.gameserver.model.conditions.ConditionPlayerIsHero;
import org.l2s.gameserver.model.conditions.ConditionPlayerIsInCombat;
import org.l2s.gameserver.model.conditions.ConditionPlayerIsOnSide;
import org.l2s.gameserver.model.conditions.ConditionPlayerIsPvpFlagged;
import org.l2s.gameserver.model.conditions.ConditionPlayerLandingZone;
import org.l2s.gameserver.model.conditions.ConditionPlayerLevel;
import org.l2s.gameserver.model.conditions.ConditionPlayerLevelRange;
import org.l2s.gameserver.model.conditions.ConditionPlayerMp;
import org.l2s.gameserver.model.conditions.ConditionPlayerPkCount;
import org.l2s.gameserver.model.conditions.ConditionPlayerPledgeClass;
import org.l2s.gameserver.model.conditions.ConditionPlayerRace;
import org.l2s.gameserver.model.conditions.ConditionPlayerRangeFromNpc;
import org.l2s.gameserver.model.conditions.ConditionPlayerRangeFromSummonedNpc;
import org.l2s.gameserver.model.conditions.ConditionPlayerServitorNpcId;
import org.l2s.gameserver.model.conditions.ConditionPlayerSex;
import org.l2s.gameserver.model.conditions.ConditionPlayerSiegeSide;
import org.l2s.gameserver.model.conditions.ConditionPlayerSouls;
import org.l2s.gameserver.model.conditions.ConditionPlayerState;
import org.l2s.gameserver.model.conditions.ConditionPlayerSubclass;
import org.l2s.gameserver.model.conditions.ConditionPlayerTransformationId;
import org.l2s.gameserver.model.conditions.ConditionPlayerVehicleMounted;
import org.l2s.gameserver.model.conditions.ConditionPlayerWeight;
import org.l2s.gameserver.model.conditions.ConditionSiegeZone;
import org.l2s.gameserver.model.conditions.ConditionSlotItemId;
import org.l2s.gameserver.model.conditions.ConditionTargetAbnormalType;
import org.l2s.gameserver.model.conditions.ConditionTargetActiveEffectId;
import org.l2s.gameserver.model.conditions.ConditionTargetActiveSkillId;
import org.l2s.gameserver.model.conditions.ConditionTargetAggro;
import org.l2s.gameserver.model.conditions.ConditionTargetCheckCrtEffect;
import org.l2s.gameserver.model.conditions.ConditionTargetClassIdRestriction;
import org.l2s.gameserver.model.conditions.ConditionTargetInvSize;
import org.l2s.gameserver.model.conditions.ConditionTargetLevel;
import org.l2s.gameserver.model.conditions.ConditionTargetLevelRange;
import org.l2s.gameserver.model.conditions.ConditionTargetMyPartyExceptMe;
import org.l2s.gameserver.model.conditions.ConditionTargetNpcId;
import org.l2s.gameserver.model.conditions.ConditionTargetNpcType;
import org.l2s.gameserver.model.conditions.ConditionTargetPlayable;
import org.l2s.gameserver.model.conditions.ConditionTargetPlayer;
import org.l2s.gameserver.model.conditions.ConditionTargetRace;
import org.l2s.gameserver.model.conditions.ConditionTargetUsesWeaponKind;
import org.l2s.gameserver.model.conditions.ConditionTargetWeight;
import org.l2s.gameserver.model.conditions.ConditionUsingItemType;
import org.l2s.gameserver.model.conditions.ConditionUsingSkill;
import org.l2s.gameserver.model.conditions.ConditionUsingSlotType;
import org.l2s.gameserver.model.conditions.ConditionWithSkill;
...
import org.l2s.gameserver.model.skills.EffectScope;
import org.l2s.gameserver.model.skills.Skill;
import org.l2s.gameserver.model.stats.Stats;
import org.l2s.gameserver.model.stats.functions.FuncTemplate;
